    ...
    <footer className="border-t border-border bg-secondary/40">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-10 md:grid-cols-4">
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground max-w-xs">
              AMPLEXA EDU OS — Plataforma inteligente universitária para a transformação digital da
              UÓR.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                <Link to="/parcerias" className="hover:text-foreground">
                  Parcerias
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li className="flex items-center gap-2">
                <Phone className="h-4 w-4" /> +244 940 900 323
              </li>
              <li className="flex items-center gap-2">
                <Mail className="h-4 w-4" /> info@uor.edu.ao
              </li>
              <li className="flex items-center gap-2">
        ...
        <div className="mt-10 pt-6 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-muted-foreground">
          <p>
            © {new Date().getFullYear()} Amplexa Soluções Digitais Inteligentes × Universidade Óscar
            Ribas.
          </p>
