...
const events = [
  {
    img: event1,
    t: "Mercado de Capitais e Banca",
    d: "19 Dez",
    h: "10:30",
    l: "Anfiteatro Alberto Maba Chocolate",
    i: 142,
  },
  {
    img: event4,
    t: "Debate · Orçamento Geral 2026",
    d: "15 Dez",
    h: "10:30",
    l: "Anfiteatro UÓR",
    i: 230,
  ...
  {
    img: event3,
    t: "Primeiras Defesas de Mestrado",
    d: "18 Set",
    h: "09:00",
    l: "Sala de Defesas",
    i: 68,
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Workshops, palestras e actividades académicas.
          </p>
        </div>
